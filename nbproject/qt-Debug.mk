...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Dec 28 15:29:11 2014
...
INCPATH       = -I/usr/local/Qt4.8/mkspecs/macx-g++ -Inbproject -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -I. -Inbproject -I. -F/Library/Frameworks
LINK          = g++
...
dist: 
	@$(CHK_DIR_EXISTS) build/Debug/GNU-MacOSX/QtApplication_11.0.0 || $(MKDIR) build/Debug/GNU-MacOSX/QtApplication_11.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-MacOSX/QtApplication_11.0.0/ && $(COPY_FILE) --parents mainwindow.hpp build/Debug/GNU-MacOSX/QtApplication_11.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp build/Debug/GNU-MacOSX/QtApplication_11.0.0/ && (cd `dirname build/Debug/GNU-MacOSX/QtApplication_11.0.0` && $(TAR) QtApplication_11.0.0.tar QtApplication_11.0.0 && $(COMPRESS) QtApplication_11.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-MacOSX/QtApplication_11.0.0`/QtApplication_11.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-MacOSX/QtApplication_11.0.0
...
build/Debug/GNU-MacOSX/main.o: main.cpp mainwindow.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-MacOSX/main.o main.cpp

build/Debug/GNU-MacOSX/mainwindow.o: mainwindow.cpp mainwindow.hpp
